...
Text-only / no identity images: `workflows/h3-fl2va-default-8s.json`. ~15 s: `workflows/h3-ref2va-long-15s08.json` (**15.08 s / 362**; never 15.00 / 15.04). Do **not** claim a live Ref2VA mp4 exists yet.
